...
export const metadata: Metadata = {
  title: {
    default: '台灣生命資訊網｜後事流程、生命禮儀、殯葬服務與塔位費用資訊',
    template: '%s｜台灣生命資訊網',
  },

  description:
    '台灣生命資訊網提供後事流程、臨終準備、往生後第一步、生命禮儀、殯葬服務、葬儀社、禮儀公司、告別式、火化、靈骨塔、塔位資訊、喪禮費用、生前契約與家屬諮詢協助，協助家屬快速了解治喪安排與相關注意事項。',
  ...
  openGraph: {
    title: '台灣生命資訊網｜後事流程、生命禮儀、殯葬服務與塔位費用資訊',
    description:
